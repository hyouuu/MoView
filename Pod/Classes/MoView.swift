...
#if os(iOS)
    import UIKit
    public typealias MoViewParent = UIView
    public typealias MoViewImage = UIImage
#else
    import AppKit
    public typealias MoViewParent = NSView
    public typealias MoViewImage = NSImage
#endif
...
public protocol MoViewDelegate: class {
    ...
    func moViewRequestImage(_ moView: MoView) -> MoViewImage?
}

public class MoView: MoViewParent {
